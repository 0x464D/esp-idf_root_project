...
static int gap_event_handler(struct ble_gap_event *event, void *arg) {
    ...
    case BLE_GAP_EVENT_SUBSCRIBE:
        //Este es un evento que indica que un cliente ha cambiado el estado de suscripción para una característica BLE 
        //(por ejemplo, empezó a recibir notificaciones o las dejó de recibir).
